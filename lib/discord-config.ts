...
export const DISCORD_RANK_CHANNEL_ID = process.env.DISCORD_RANK_CHANNEL_ID?.trim() || '1548213833753956433';
export const DISCORD_WELCOME_CHANNEL_ID = process.env.DISCORD_WELCOME_CHANNEL_ID?.trim() || '1548209055569420380';
