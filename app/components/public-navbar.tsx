...
export default async function PublicNavbar({ returnTo }: { returnTo: string }) {
  ...
  return <ResponsiveNavbar
    bell={isActive ? <NotificationBell /> : undefined}
    upload={isActive ? <Link href="/upload" className="navMobileUpload" aria-label="Share a shot" title="Share a shot"><span aria-hidden="true">＋</span></Link> : undefined}
  >
