...
import type { trustedProgress } from '../../lib/trusted-data';
type Progress=Awaited<ReturnType<typeof trustedProgress>>;
export default function TrustedApplication({initial,appeal=false}:{initial:Progress;appeal?:boolean}){
