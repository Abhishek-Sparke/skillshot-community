...
export type IconName = 'announcement'|'arrow-up-right'|'bookmark'|'check'|'close'|'comment'|'edit'|'eye'|'folder'|'heart'|'link'|'location'|'lock'|'message'|'more'|'pin'|'plus'|'search'|'share'|'trash';
...
const paths: Record<IconName, ReactNode> = {
  ...
  folder: <path d="M20 20a2 2 0 0 0 2-2V8a2 2 0 0 0-2-2h-7.9a2 2 0 0 1-1.6-.8L9.3 3.6A2 2 0 0 0 7.7 3H4a2 2 0 0 0-2 2v13a2 2 0 0 0 2 2Z"/>,
