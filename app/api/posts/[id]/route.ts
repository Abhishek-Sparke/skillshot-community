...
import { reverseRelatedXp, reverseXp } from '../../../../lib/xp';
...
export async function DELETE(_: Request, { params }: { params: Promise<{ id: string }> }) {
  ...
  await reverseXp(`skillshot-published:${id}`,'Skillshot deleted');
  await reverseRelatedXp('SKILLSHOT',id,'Skillshot deleted');
